...
docker run -d -p 9000:9000 --restart=always --name=portainer -v /var/run/docker.sock:/var/run/docker.sock --name prtainer  portainer/portainer

curl -o /home/linux/Documents/redis/redis.conf http://download.redis.io/redis-stable/redis.conf
